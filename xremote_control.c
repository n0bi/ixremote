...
XRemoteApp* xremote_control_alloc(XRemoteAppContext* app_ctx) {
    ...
    xremote_app_submenu_add(
        app, "Control Pad", XRemoteViewIRControl, xremote_control_submenu_callback);
    xremote_app_submenu_add(
        app, "D-Pad", XRemoteViewIRNavigation, xremote_control_submenu_callback);
    xremote_app_submenu_add(
        app, "Playback", XRemoteViewIRPlayback, xremote_control_submenu_callback);
    xremote_app_submenu_add(
        app, "Custom Pad", XRemoteViewIRCustomPage, xremote_control_submenu_callback);
    xremote_app_submenu_add(
        app, "Layout", XRemoteViewIRCustomEditPage, xremote_control_submenu_callback);
