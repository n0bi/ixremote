...
int32_t xremote_main(void* p) {
    ...
    xremote_app_submenu_add(app, "Learn Remote", XRemoteViewLearn, xremote_submenu_callback);
    xremote_app_submenu_add(app, "Saved Remotes", XRemoteViewIRSubmenu, xremote_submenu_callback);
    xremote_app_submenu_add(app, "Signal Analyzer", XRemoteViewAnalyzer, xremote_submenu_callback);
